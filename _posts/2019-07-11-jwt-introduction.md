...
date: 2019-07-11 10:25:05 -0400
categories: guide auth jwt
---

<!-- TOC START min:1 max:4 link:true asterisk:true update:true -->
* [JWT (JSON Web Token) Introduction](#jwt-json-web-token-introduction)
    * [JWT란 무엇인가](#jwt란-무엇인가)
    * [JWT 인증 방식 예시](#jwt-인증-방식-예시)
    * [JWT는 일반 토큰과 무엇이 다른가](#jwt는-일반-토큰과-무엇이-다른가)
    * [JWT는 어떻게 생겼는가](#jwt는-어떻게-생겼는가)
        * [헤더](#헤더)
        * [페이로드](#페이로드)
        * [서명](#서명)
    * [요약](#요약)
